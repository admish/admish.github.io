...
_tl;dr Scientists look at DNA by electrocuting jell-o._
...
For more information on how electrophoresis works,  [here is a quick video that should help explain](https://www.youtube.com/watch?v=u_WqMXmCi7c "https://www.youtube.com/watch?v=u_WqMXmCi7c").

![](/uploads/ep_comb_render.jpg)

## Customizable comb

Various projects have their own needs and laboratories have their own preferences. This can be more wells at once, or larger wells that hold greater volumes. Creating the comb in [OpenSCAD](http://www.openscad.org/) makes it easy to change the style of the comb. A computer novice should be able to understand enough about the program within an hour or so to get a working STL file they can then print. As long as you know the measurements and account for the overall width, this design should allow anyone to make their own comb anyway they desire.

[OpenSCAD](http://www.openscad.org/) is a free open source program available on Mac, Windows, and Linux.

## Pricing gouging

Another reason that I wanted to create a 3D model of this comb is the price. These combs are nothing fancy, just plastic. [Bio-Rad](http://www.bio-rad.com/en-us/product/mini-sub-cell-gt-cell), one of the largest vendors for electrophoresis equipment charges about $60 per comb. [Gelcombs.com](https://gelcombs.com/) offers discounted versions that sell for $45 each. Neither of them offer options to make custom combs.

I have them available on [Shapeways](https://www.shapeways.com/shops/admish?section=Electrophoresis+Combs&s=0) for purchase in acrylic only at about $19 each. There is a $1-$3 markup, but you are welcome to download the STL files and print them on your own. The acrylic is printed in wax so they have a waxy film on them when they arrive from Shapeways. Wax melts above 37°C (99°F) and acrylic melts at 160°C (320°F). Running them through a phase 3 autoclave wash, or maybe a consumer dishwasher should remove the wax.
...
The code for the electrophoresis combs can be downloaded at [GitHub](https://github.com/admish/Electrophoresis-Comb) and are available for on-demand purchase from [Shapeways](https://www.shapeways.com/shops/admish?section=Electrophoresis+Combs&s=0)